...
object SkillNongSuoShui : AbstractSkill, YuanSu, AbstractDanCast {
    ...
    override val name: String = "浓缩水元素"
    ...
    override fun onRun(player: Player, level: Int): Boolean {
        ...
        target.forEach {
            if (!Team.canAttack(player, it)) {
                ...
                it.addPotionEffect(PotionEffectType.JUMP.createEffect(20 * 3, 4))
            }
        }
        BuffManager.add(player, BuffLuanSaQingHe.id, 1, 20 * 5, player.uniqueId)
        return true
    }
