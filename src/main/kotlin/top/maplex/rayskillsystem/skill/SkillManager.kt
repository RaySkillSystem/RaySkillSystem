...
object SkillManager {
    ...
    fun eval(player: Player, name: String, level: Int, callBack: AbstractSkill.() -> Unit = {}): Boolean {
        ...
        CooldownAPI.set(player, "Skill_${name}", skill.cooldown)
